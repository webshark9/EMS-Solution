...
namespace AllEmployees
{
    public class ParttimeEmployee : Employee
    {
        ...
        /**
        * \brief Sets the dateOfHire attibute within the ParttimeEmployee class
        *
        * \details <b>Details</b>
        *
        ...
        */
        ...
        /**
        * \brief Retreives the dateOfHire attribute from the ParttimeEmployee class
        *
        * \details <b>Details</b>
        *
        ...
        */
        ...
        /**
        * \brief Sets the dateOfTermination attibute within the ParttimeEmployee class
        *
        * \details <b>Details</b>
        *
        * This method will take in a DateTime variable, given by the user, and call on
        ...
        */
        ...
        /**
        * \brief Retreives the dateOfTermination attribute from the ParttimeEmployee class
        *
        * \details <b>Details</b>
        *
        ...
        */
        ...
        /**
        * \brief Retreives the hourlyRate attribute from the ParttimeEmployee class
        *
        * \details <b>Details</b>
        *
