/// \class Logging
/// 
/// \brief Contains the Logging class that deals with logging events
/// 
/// File: Logging.cs
...
/// the current day and logging events from other classes
/// 
...
namespace Supporting
{
    class Logging
    {
        ...
        * \details <b>Details</b>
        *
        * The format for the log file name is: 
        * date (YYYY-MM-DD) followed by "EMS_Log_File"
        * \param None
        * 
        ...
        * 
        * \return A bool <i>logSuccessful</i> which will be 'true' if the log was successful and 'false' otherwise
        *
        */
